...
public class ConvenioBean {
    ...
    private final String comparativo = "convenio";
    ...
    public void listarConvenio(){
        ...
        try {
            ...
            //List<Convenio> listanew = this.conveniodao.listaDeConvenio();
            if(listaConvenio != null){
                //for(Convenio listanio: listanew){
                    System.out.println(listaConvenio.get(0).getTipoDeConvenio());
//                    this.listaConvenio.add(listanio); 
                    //System.out.println(this.listaConvenio.get(0).getTipoDeConvenio());
                //}
